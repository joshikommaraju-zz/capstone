...
import { createMarks } from '../src/graphql/mutations';
...
class QuizMain extends Component{
  ...
  async componentDidMount(){
    ...
    this.setState({QP: paper, subjectCode:SC, subjectName:SN,userID: usID, examID: exID,negflag: paper.marknegative});
  ...
  async handleSubmit(){
    ...
    //console.log("data",this.state.examID, this.state.subjectCode, this.state.subjectName, this.state.examID)
    await API.graphql(graphqlOperation(createMarks, {input:{type:"Quiz", maxMarks:this.state.QP.totalmarks, marksObtained: this.state.marks,date: this.state.QP.date,name: this.state.QP.heading, subjectCode: this.state.subjectCode, marksExamId: this.state.examID, marksStudentId: this.state.userID}}));
    //mutation
