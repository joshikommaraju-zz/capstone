...
onBackButtonPressed() {
  ...
  async componentDidMount() {
    ...
    console.log('Entered FTP',this.state.link)
  ...
  render(){
    return (
      ...
      <FloatingAction floatingIcon={require("../assets/close.png")} position="left" distanceToEdge={{vertical:height*0.89,horizontal:width*0.85}} buttonSize={40} listenKeyboard={false} color="#fff" onPressMain={()=>Actions.pop()} />
    </View>
