...
import MakeAssignment from "../screens/MakeAssignment.js"
   ...
   render(){
      return(
         <Router>
            ...
            <Scene key = "verification" component = {Verification} hideNavBar={true}  />
            <Scene key = "makeAssignment" component = {MakeAssignment} hideNavBar={true}  />
            </Scene>
         </Router>
      );
   };
